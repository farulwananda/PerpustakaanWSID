...
--
-- Host: localhost:3306
-- Waktu pembuatan: 01 Jul 2021 pada 08.08
...
('BK001', 'Dunia Indah', 'Darwin', 2011, 'PT001', 'KT002', 8),
('BK002', 'Bahasa Inggris', 'Luciel', 2010, 'PT002', 'KT002', 5);
...
INSERT INTO `peminjaman` (`id_peminjaman`, `id_detail`, `tanggal_pinjam`, `tanggal_kembali`, `id_siswa`, `id_petugas`) VALUES
...
('SI003', 'Bulan', '089682125743', 'Jl.Bunga', 'Wanita');
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_ibfk_1` FOREIGN KEY (`id_siswa`) REFERENCES `siswa` (`id_siswa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `pengembalian`
  ADD CONSTRAINT `pengembalian_ibfk_1` FOREIGN KEY (`id_siswa`) REFERENCES `siswa` (`id_siswa`) ON DELETE CASCADE ON UPDATE CASCADE,
